...
[
  ...
  }
  {
    ...
    warnings = [ "If you do not allow this plugin to query the system's ACPI, i.e. the plugin option `use_acpi` is set to `False`, then you need at least one of the optional dependencies." ];
  }
  {
    name = "caffeine";
